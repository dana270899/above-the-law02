...
alter table public.leaderboard_entries
drop constraint if exists leaderboard_entries_flow_points_check;

alter table public.leaderboard_entries
add constraint leaderboard_entries_flow_points_check
check (flow_points between -100000 and 100000);
...
begin
  ...
  if invalid_items > 0
     ...
     or calculated_score + new.mini_game_points + new.flow_points <> new.score
