...
export const OPERATION_SOUNDS: OperationSoundOption[] = [
  ...
  { id: 'minister-sound', label: 'Minister',          src: assetUrl('/sounds/Minister sound.mp3') },
  { id: 'forces-sound',   label: 'Forces',            src: assetUrl('/sounds/Forces.mp3') },
  { id: 'dog-sound',      label: 'Dog',               src: assetUrl('/sounds/Dog.mp3') },
  { id: 'press-sound',    label: 'Press',             src: assetUrl('/sounds/Press.mp3') },
  { id: 'rope-sound',     label: 'Rope',              src: assetUrl('/sounds/Rope.mp3') },

  // Generic toggle / click sounds.
  { id: 'light-switch-01', label: 'Light Switch 01',  src: assetUrl('/sounds/Light Switch 01.wav') },
  { id: 'light-switch-02', label: 'Light Switch 02',  src: assetUrl('/sounds/Light Switch 02.wav') },
  { id: 'light-switch-03', label: 'Light Switch 03',  src: assetUrl('/sounds/Light Switch 03.wav') },

  // Misc / shared with other features.
  { id: 'notification',         label: 'Notification chime',  src: assetUrl('/sounds/notification.mp3') },
  { id: 'angry-01-mp3',         label: 'Angry 01',            src: assetUrl('/sounds/angry01.mp3') },
  { id: 'angry-02-mp3',         label: 'Angry 02 (mp3)',      src: assetUrl('/sounds/angry02.mp3') },
  { id: 'angry-02-wav',         label: 'Angry 02 (wav)',      src: assetUrl('/sounds/angry02.wav') },
  { id: 'hashem-itbarach-mp3',  label: 'Hashem Itbarach (mp3)', src: assetUrl('/sounds/Hashem Itbarach.mp3') },
  { id: 'hashem-itbarach-wav',  label: 'Hashem Itbarach (wav)', src: assetUrl('/sounds/Hashem Itbarach.wav') },
  { id: 'falafel-pixel',        label: 'Falafel Pixel Pursuit', src: assetUrl('/sounds/Falafel Pixel Pursuit.wav') },
]
